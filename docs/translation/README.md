...
For model selection and licensing considerations for NER models, see [`multilingual-ner/considerations.md`](https://github.com/ay94/multilingual-ner/blob/main/considerations.md).
